...
{
  score_t similarity[64][64]; /* - [2D array int] 1-based codon/codon similarity
                                 table */
  ...
  char codon[65]
            [4]; /* - [64 x 3 char array] 1-based codon to base letters table */
...
sim_matrix_t* gen_sim_matrix(int exact, int similar, int dissimilar,
